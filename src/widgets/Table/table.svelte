<script>
    ...
    function reload() {
        ...
        prefs.set("filters", filterParam);
        prefs.set("sort", sortParam);
    ...
    function loadFromPrefs(name) {
        let val = prefs.get(name);
